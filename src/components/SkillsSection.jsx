...
import { SiSpring, SiSqlite, SiOllama, SiLangchain, SiTypescript, SiMacos, SiFastapi } from "react-icons/si";
...
const skills = [
  ...
  { name: "MacOS", category: "Operating Systems", icon: SiMacos },


  { name: "RAG", category: "AI", icon: GiSparkles },
  { name: "LLM", category: "AI", icon: GiSparkles },
  ...
  { name: "API REST", category: "Tools", icon: AiOutlineApi },
  { name: "Node.js", category: "Tools", icon: FaNode },
  { name: "AWS", category: "Tools", icon: FaAws },
  { name: "Figma", category: "Tools", icon: FaFigma },
];

const categories = ["all", "Frontend", "Backend", "Database", "Operating Systems","AI", "Tools"];
...
function SkillsSection() {
  ...
  const labelCategorie = (category) => {
    ...
    if (category === "AI") return t("skills_cat_ai");
